...
<body>
	...
	<nav class="navbar fixed-top">
		<div class="icon">
			Cute:)<span style="color: #00E8E8;">Family</span> <span
				class="navbarTitle"> 後台管理系統 </span>
		</div>
		...
		<div class="action" id="navbarMenu">
			...
			<div class="nav-item dropdown">
				<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					...
					aria-expanded="false"> <span class="mem-name">職稱:姓名</span> <img
	...
	<div class="container-xl">
		...
		<div class="row">
			...
			<div class="main col-xl-9">
				...
				<div class="mainTitle">預約管理</div>

				<hr class="mainTitlehr">

				<form>
					預約日期：<input type="date" name=""> 預約時段：<select
						name="optsession">
					...
					</select> <input type="submit" name="" value="查詢">
